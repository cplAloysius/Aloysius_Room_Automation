...
The Misubishi Electric Air Conditioner is controlled by an infrared remote. The signal from the remote can be imitated by an IR transmitter. An NPN is used as a switch to drive the IR led. 
